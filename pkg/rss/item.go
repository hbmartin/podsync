...
type Item struct {
	...
	Author           *Author    `xml:"-"` //nolint:staticcheck // upstream tag layout; Author is excluded from item encoding
	...
	PodcastTranscripts     []*Transcript     `xml:"podcast:transcript,omitempty"`
	PodcastChapters        *Chapters         `xml:"podcast:chapters,omitempty"`
	PodcastPersons         []*Person         `xml:"podcast:person,omitempty"`
	PodcastSocialInteracts []*SocialInteract `xml:"podcast:socialInteract,omitempty"`
}
